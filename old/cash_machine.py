...
class CashMachineInsertMoneyBill:
    ...
    def insert_money_bill(money_bill, amount):
        ...
        EscreverDinheiroNoArquivo().escrever_dinheiro_combinado(cash_machine.money_slips)
        return cash_machine
...
class CashMachineWithDraw:
    ...
    def __balance_debit(bank_account, value):
        ...
        EscreverArquivoBanco().escrever_conta_banco(bank_account)
...
class CashMachineGetter:  # design pattern - factory
    ...
    def get(self):
        ...
        money_slips = LerArquivoCombinarDinheiro().obter_dinheiro_combinado()
